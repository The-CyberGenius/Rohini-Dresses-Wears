...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-navy-950 to-navy-900 text-white">
      {/* Top gold border */}
      <div className="h-1 bg-gradient-to-r from-primary-400 via-gold-400 to-primary-500" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-heading font-bold text-lg mb-4 text-primary-300">Quick Links</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-heading font-bold text-lg mb-4 text-primary-300">Contact Us</h4>
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+919602911100" className="text-navy-300 hover:text-primary-300 transition-colors text-sm">
                  +91 96029 11100
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@rohinidresses.com" className="text-navy-300 hover:text-primary-300 transition-colors text-sm">
                  info@rohinidresses.com
                </a>
              </div>
              <div className="flex gap-3 mt-4">
                <a
                  href="https://wa.me/919602911100"
                  target="_blank"
                ...
                <a
                  href="https://instagram.com/rohinidresses"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://facebook.com/rohinidresses"
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <div className="mt-12 pt-8 border-t border-navy-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-navy-400 text-sm">
              © 2024 Rohini Dresses & Wears. All rights reserved.
            </p>
            <div className="flex items-center gap-4">
              <Link href="/admin" className="text-navy-500 hover:text-navy-300 text-sm transition-colors">
                Admin Panel
              </Link>
